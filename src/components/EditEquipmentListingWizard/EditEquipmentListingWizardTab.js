  ...
  switch (tab) {
    case GENERAL: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditEquipmentListingWizard.saveNewGeneral'
    ...
    case LOCATION: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditEquipmentListingWizard.saveNewLocation'
        : 'EditEquipmentListingWizard.saveEditLocation';
      return (
        <EditListingLocationPanel
          {...panelProps(LOCATION)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    ...
    case PRICING: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditEquipmentListingWizard.saveNewPricing'
        : 'EditEquipmentListingWizard.saveEditPricing';
      return (
        <EditListingPricingPanel
          {...panelProps(PRICING)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    ...
    case AVAILABILITY: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditEquipmentListingWizard.saveNewAvailability'
        : 'EditEquipmentListingWizard.saveEditAvailability';
      return (
        <EditListingAvailabilityPanel
    ...
    case PHOTOS: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditEquipmentListingWizard.saveNewPhotos'
        : 'EditEquipmentListingWizard.saveEditPhotos';
